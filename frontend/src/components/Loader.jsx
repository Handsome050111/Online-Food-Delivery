    ...
    const loaderContent = (
        <div className="flex flex-col items-center justify-center space-y-6">
            <div className="relative flex items-center justify-center">
                <div className="absolute w-24 h-24 border-4 border-primary-100 dark:border-primary-900/30 border-t-primary-500 rounded-full animate-spin"></div>
                <img src={logo} alt="Loading..." className="h-14 w-auto object-contain z-10 animate-pulse" />
            </div>
