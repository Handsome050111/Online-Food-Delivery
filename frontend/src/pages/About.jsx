...
const About = () => {
    return (
        <div className="bg-gray-50 min-h-screen pb-16">
            {/* Hero Section */}
            <div className="bg-primary-600 text-white py-20 px-4 sm:px-6 lg:px-8 text-center">
                <div className="max-w-3xl mx-auto">
                    <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight mb-6">Our Mission is to Deliver Happiness</h1>
                    <p className="text-lg sm:text-xl font-medium text-primary-100 leading-relaxed">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 text-center transform hover:-translate-y-1 transition-transform">
                        ...
                        <p className="text-gray-600 font-medium leading-relaxed">We partner with local restaurants to help them grow and reach more customers in their neighborhoods.</p>
                    </div>
                    <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 text-center transform hover:-translate-y-1 transition-transform">
                        <div className="mx-auto w-16 h-16 bg-primary-100 text-primary-600 rounded-full flex items-center justify-center mb-6">
                            <Target size={32} />
                        </div>
                        <h3 className="text-xl font-extrabold text-gray-900 mb-3">Lightning Fast</h3>
                        <p className="text-gray-600 font-medium leading-relaxed">Our advanced routing algorithms ensure your food arrives hot and fresh, exactly when you expect it.</p>
                    </div>
                    <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 text-center transform hover:-translate-y-1 transition-transform">
                        <div className="mx-auto w-16 h-16 bg-primary-100 text-primary-600 rounded-full flex items-center justify-center mb-6">
                            <Award size={32} />
                        </div>
                        <h3 className="text-xl font-extrabold text-gray-900 mb-3">Quality Assured</h3>
                        <p className="text-gray-600 font-medium leading-relaxed">We thoroughly vet every restaurant on our platform to guarantee you get the highest quality meals.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 mt-8">
                <div className="flex flex-col md:flex-row items-center gap-12">
                    ...
                    <div className="md:w-1/2 space-y-6">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary-100 text-primary-700 font-bold text-sm">
                            <Heart size={16} /> Our Story
                        </div>
                        <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 tracking-tight">How We Started</h2>
