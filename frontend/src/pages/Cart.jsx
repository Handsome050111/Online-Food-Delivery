            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {cartItems.length > 0 ? (
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        <div className="lg:col-span-2">
                            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 mb-6">
                                <div className="flex justify-between items-center mb-6 border-b border-gray-100 pb-4">
                                    <div>
                                        <h2 className="text-xl font-extrabold text-gray-900">Order Items</h2>
                                        {cart.restaurant && <p className="text-sm font-medium text-gray-500 mt-1">From {cart.restaurant.name}</p>}
                                    </div>
                                    <span className="bg-primary-50 text-primary-700 font-bold px-3 py-1 rounded-full text-sm">{cartItems.length} items</span>
                                </div>
                            ...
                            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
                                <h3 className="text-lg font-extrabold text-gray-900 mb-4">Special Instructions</h3>
                                <textarea
                                    rows="3"
                                    placeholder="E.g. No onions, extra ketchup, ring the doorbell..."
                                    className="w-full bg-gray-50 border border-gray-200 rounded-xl p-4 font-medium text-gray-700 focus:outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500 resize-none transition-all"
                                ></textarea>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 sticky top-24">
                                ...
                                <div className="flex bg-gray-50 border border-gray-200 rounded-xl p-1 mb-6 focus-within:border-primary-400 focus-within:ring-2 focus-within:ring-primary-100 transition-all">
                                    <div className="pl-4 flex items-center text-gray-400">
                                        <Tag size={18} />
                                    </div>
                                    <input type="text" placeholder="Promo code" className="w-full bg-transparent border-none focus:outline-none px-3 text-sm font-bold placeholder-gray-400" />
                                ...
                                <div className="flex justify-between items-center py-6">
                                    ...
                                    <span className="text-3xl font-extrabold text-primary-600">Rs. {total.toFixed(0)}</span>
                                </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center max-w-2xl mx-auto">
                        ...
                        <p className="text-gray-500 mb-8 max-w-md mx-auto text-lg">Looks like you haven't added anything to your cart yet. Explore our top restaurants to find something delicious.</p>
