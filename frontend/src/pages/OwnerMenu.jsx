    ...
    return (
        <div className="animate-in fade-in duration-500">
            <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 mb-8">
                <div>
                    <h1 className="text-2xl font-extrabold text-gray-900 tracking-tight">Manage Menu</h1>
                    <p className="text-gray-500 font-medium pt-1">Create, update, and organize your dishes.</p>
                </div>
                <button
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div className="p-4 border-b border-gray-100 bg-gray-50/50">
                    <div className="flex items-center bg-white rounded-xl px-4 py-2 border border-gray-200 focus-within:ring-2 focus-within:ring-primary-100 focus-within:border-primary-400 transition-all max-w-md shadow-sm">
                                    ...
                                    <tr key={item._id} className="border-b border-gray-50 hover:bg-gray-50 transition-colors group">
                                        <td className="py-4 px-6">
                                            <div className="flex items-center gap-4">
                                                <div className="w-14 h-14 rounded-xl bg-gray-100 overflow-hidden flex-shrink-0 shadow-sm border border-gray-200 group-hover:border-primary-200 transition-colors">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-gray-500 font-medium pt-0.5 line-clamp-1 max-w-xs">{item.description}</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="py-4 px-6">
                                            <span className="px-3 py-1 bg-gray-100 text-gray-600 rounded-lg text-xs font-bold capitalize border border-gray-200">
                                                {item.category}
                                            </span>
                                        </td>
                                        <td className="py-4 px-6 font-extrabold text-gray-900 border-none">${item.price.toFixed(2)}</td>
                                        <td className="py-4 px-6">
                                            {item.popular ? (
                                                <span className="text-amber-600 font-bold bg-amber-50 px-2.5 py-1 rounded-lg text-xs border border-amber-200">Popular</span>
                                            ) : (
                                                <span className="text-gray-500 font-bold bg-gray-100 px-2.5 py-1 rounded-lg text-xs border border-gray-200">Standard</span>
                                            )}
                                        </td>
                                        <td className="py-4 px-6 text-right">
                                            <div className="flex justify-end gap-2">
                                                <button onClick={() => handleDeleteItem(item._id)} className="p-2 text-red-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors">
            ...
            {showModal && (
                <div className="fixed inset-0 bg-gray-900/60 z-50 flex items-center justify-center p-4 backdrop-blur-sm overflow-y-auto">
                    <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 w-full max-w-lg animate-in zoom-in-95 duration-200 my-8">
                        <div className="flex justify-between items-center p-6 border-b border-gray-100 sticky top-0 bg-white rounded-t-2xl z-10">
                            <h2 className="text-xl font-extrabold text-gray-900 tracking-tight">Add Menu Item</h2>
                        ...
                        <form onSubmit={handleAddItem} className="p-6">
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input 
                                        ...
                                        className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-100 focus:border-primary-400 transition-colors font-medium outline-none" 
                                ...
                                <div>
                                    ...
                                    <textarea 
                                        ...
                                        className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-100 focus:border-primary-400 transition-colors font-medium outline-none resize-none h-24" 
                                ...
                                <div>
                                    ...
                                    />
                                    <p className="text-xs text-gray-500 font-bold mt-1.5 ml-1">Leave blank to use a default image placeholder.</p>
                                </div>
                                ...
                                <div className="pt-2">
                                    <label className="flex items-center gap-3 cursor-pointer p-3 rounded-xl border border-gray-200 bg-gray-50 hover:bg-gray-100 transition-colors">
                                        ...
                                        />
                                        <div>
                                            <span className="block text-sm font-bold text-gray-900">Mark as Popular</span>
                                            <span className="block text-xs text-gray-500 font-medium mt-0.5">Highlights this dish on your menu</span>
                                        </div>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div className="mt-8 flex justify-end gap-3 pt-4 border-t border-gray-100">
                                <button type="button" onClick={() => setShowModal(false)} className="px-6 py-2.5 bg-white border border-gray-200 text-gray-700 font-bold rounded-xl hover:bg-gray-50 hover:text-gray-900 transition-all active:scale-95 shadow-sm">
                                    Cancel
                                </button>
