...
const PrivacyPolicy = () => {
    return (
        <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8 font-sans transition-colors duration-300">
            <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 dark:text-white tracking-tight mb-8">Privacy Policy</h1>
            ...
            <div className="prose prose-lg text-gray-600 dark:text-gray-400 space-y-6">
                ...
                <section>
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">3. Data Sharing and Disclosure</h2>
