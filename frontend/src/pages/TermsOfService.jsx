...
const TermsOfService = () => {
    return (
        <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8 font-sans">
            <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 tracking-tight mb-8">Terms of Service</h1>
            ...
            <div className="prose prose-lg text-gray-600 space-y-6">
                ...
                <section>
                    <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">3. Ordering and Payment</h2>
